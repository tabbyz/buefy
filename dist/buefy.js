   ...
   */
    ...
    var __vue_render__$w = function () {
        var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return _c('div', {directives: [{name: 'click-outside', rawName: 'v-click-outside', value: (_vm.closeMenu), expression: 'closeMenu'}],
            ...
            on: {'mouseenter': _vm.checkHoverable}}, [_c('a', {staticClass: 'navbar-link',
            class: {
                'is-arrowless': _vm.arrowless,
                'is-active': _vm.newActive && _vm.collapsible
            },
            attrs: {'role': 'menuitem', 'aria-haspopup': 'true', 'href': '#'},
            on: {'click': function ($event) { $event.preventDefault(); _vm.newActive = !_vm.newActive }}}, [(_vm.label) ? [_vm._v(_vm._s(_vm.label))] : _vm._t('label')], 2), _c('div', {directives: [{name: 'show', rawName: 'v-show', value: (!_vm.collapsible || (_vm.collapsible && _vm.newActive)), expression: '!collapsible || (collapsible && newActive)'}],
    ...
    var __vue_render__$P = function () {
        var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return _c('div', {staticClass: 'b-table'}, [_vm._t('default'), (_vm.mobileCards && _vm.hasSortablenewColumns) ? _c('b-table-mobile-sort', {attrs: {'current-sort-column': _vm.currentSortColumn, 'sort-multiple': _vm.sortMultiple, 'sort-multiple-data': _vm.sortMultipleDataComputed, 'is-asc': _vm.isAsc, 'columns': _vm.newColumns, 'placeholder': _vm.mobileSortPlaceholder, 'icon-pack': _vm.iconPack, 'sort-icon': _vm.sortIcon, 'sort-icon-size': _vm.sortIconSize}, on: {'sort': function (column, event) { return _vm.sort(column, null, event) }, 'removePriority': function (column) { return _vm.removeSortingPriority(column) }}}) : _vm._e(), (_vm.paginated && (_vm.paginationPosition === 'top' || _vm.paginationPosition === 'both')) ? [_vm._t('pagination', [_c('b-table-pagination', _vm._b({attrs: {'per-page': _vm.perPage, 'paginated': _vm.paginated, 'rounded': _vm.paginationRounded, 'icon-pack': _vm.iconPack, 'total': _vm.newDataTotal, 'current-page': _vm.newCurrentPage, 'aria-next-label': _vm.ariaNextLabel, 'aria-previous-label': _vm.ariaPreviousLabel, 'aria-page-label': _vm.ariaPageLabel, 'aria-current-label': _vm.ariaCurrentLabel}, on: {'update:currentPage': function ($event) { _vm.newCurrentPage = $event }, 'update:current-page': function ($event) { _vm.newCurrentPage = $event }, 'page-change': function (event) { return _vm.$emit('page-change', event) }}}, 'b-table-pagination', _vm.$attrs, false), [_vm._t('top-left')], 2)])] : _vm._e(), _c('div', {staticClass: 'table-wrapper', class: _vm.tableWrapperClasses, style: (_vm.tableStyle)}, [_c('table', {staticClass: 'table', class: _vm.tableClasses, attrs: {'tabindex': !_vm.focusable ? false : 0}, on: {'keydown': [function ($event) { if (!$event.type.indexOf('key') && _vm._k($event.keyCode, 'up', 38, $event.key, ['Up', 'ArrowUp'])) { return null } if ($event.target !== $event.currentTarget) { return null }$event.preventDefault(); return _vm.pressedArrow(-1) }, function ($event) { if (!$event.type.indexOf('key') && _vm._k($event.keyCode, 'down', 40, $event.key, ['Down', 'ArrowDown'])) { return null } if ($event.target !== $event.currentTarget) { return null }$event.preventDefault(); return _vm.pressedArrow(1) }]}}, [(_vm.newColumns.length && _vm.showHeader) ? _c('thead', [_c('tr', [(_vm.showDetailRowIcon) ? _c('th', {attrs: {'width': '40px'}}) : _vm._e(), (_vm.checkable && _vm.checkboxPosition === 'left') ? _c('th', {class: ['checkbox-cell', { 'is-sticky': _vm.stickyCheckbox } ]}, [(_vm.headerCheckable) ? [_c('b-checkbox', {attrs: {'value': _vm.isAllChecked, 'disabled': _vm.isAllUncheckable}, nativeOn: {'change': function ($event) { return _vm.checkAll($event) }}})] : _vm._e()], 2) : _vm._e(), _vm._l((_vm.visibleColumns), function (column, index) {
            return _c('th', {key: column.newKey + ':' + index + 'header',
                ...
                style: (column.style),
                on: {'click': function ($event) { $event.stopPropagation(); return _vm.sort(column, null, $event) }}}, [_c('div', {staticClass: 'th-wrap',
                class: {
            ...
            return _c('th', {key: column.newKey + ':' + index + 'searchable', class: {'is-sticky': column.sticky}, style: (column.style)}, [_c('div', {staticClass: 'th-wrap'}, [(column.searchable) ? [(column.$scopedSlots &&
    ...
    /* template */
    var __vue_render__$Q = function () {
        var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return _c('div', {staticClass: 'b-tabs', class: _vm.mainClasses}, [_c('nav', {staticClass: 'tabs', class: _vm.navClasses}, [_c('ul', _vm._l((_vm.items), function (childItem) {
            return _c('li', {directives: [{name: 'show', rawName: 'v-show', value: (childItem.visible), expression: 'childItem.visible'}],
                key: childItem.value,
        ...
        }), 0)]), _c('section', {staticClass: 'tab-content', class: {'is-transitioning': _vm.isTransitioning}}, [_vm._t('default')], 2)])
    }
    var __vue_staticRenderFns__$Q = []
    ...
    var __vue_render__$R = function () {
        var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return (_vm.attached && _vm.closable) ? _c('div', {staticClass: 'tags has-addons'}, [_c('span', {staticClass: 'tag', class: [_vm.type, _vm.size, { 'is-rounded': _vm.rounded }]}, [_c('span', {class: { 'has-ellipsis': _vm.ellipsis }}, [_vm._t('default')], 2)]), _c('a', {staticClass: 'tag',
            class: [_vm.size,
                _vm.closeType,
                {'is-rounded': _vm.rounded},
